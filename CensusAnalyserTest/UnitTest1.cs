...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\IndiaStateCensusData.csv";
        ...
        static string IndianStateCesusFilePathWithWrongDelimeter = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFileType = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\IndiaStateCensusData.txt";
        static string indianStateCodeHeaders = @"SrNo,State Name,TIN,StateCode";
        static string IndianStateCesusFilePathWithWrongHeader = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\WrongIndiaStateCensusData.csv";
        static string indianStateCodePath = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\IndiaStateCode.csv";
        static string WrongIndianStateCodeFilePath = @"C:\Users\Dell\DotNetProjects\Ce\WrongIndiaStateCode.csv";
        static string WrongIndianStateCodeFileTypePath = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\IndiaStateCode.txt";
        static string IndianStateCodeFilePathWrongDelimeter = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\DelimiterIndiaStateCode.csv";
        static string IndianStateCodeFilePathWrongHeader = @"C:\Users\Dell\DotNetProjects\CensusAnalyserTest\Utility\WrongIndiaStateCode.csv";
